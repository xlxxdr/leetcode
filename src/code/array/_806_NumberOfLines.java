...
public class _806_NumberOfLines {
    ...
    public static void main(String[] args) {
        _806_NumberOfLines app = new _806_NumberOfLines();
        Asserts.equals(new int[]{1, 100}, app.numberOfLines(
                new int[]{3,4,10,4,8,7,3,3,4,9,8,2,9,6,2,8,4,9,9,10,2,4,9,10,8,2},
                "mqblbtpvicqhbrejb"));
        Asserts.equals(new int[]{3, 60}, app.numberOfLines(
                new int[]{10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10},
                "abcdefghijklmnopqrstuvwxyz"));
        Asserts.equals(new int[]{2, 4}, app.numberOfLines(
